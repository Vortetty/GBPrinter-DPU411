...
HalfStepper::HalfStepper(d_word totalSteps, byte pin1, byte pin2, SteppingMode steppingMode)
...
HalfStepper::HalfStepper(d_word totalSteps, byte pin1, byte pin2, byte pin3, byte pin4,
...
void HalfStepper::SetPosition(d_word position) { _Position = position; }

d_word HalfStepper::GetPosition() const { return _Position; }

_word HalfStepper::GetSpeedRPMs() const { return _SpeedRPMs; }
...
void HalfStepper::StepForward(d_word numSteps) { this->Step((long)numSteps); }

void HalfStepper::StepBackward(d_word numSteps) { this->Step((long)-1 * (long)numSteps); }

void HalfStepper::StepTo(d_word position)
{
